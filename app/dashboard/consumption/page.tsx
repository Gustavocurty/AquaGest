  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Histórico de Consumo</h1>
      </div>
      ...
      <Card className="p-6">
        ...
        <div className="flex items-baseline gap-3 mb-1">
          <p className="text-4xl font-bold text-gray-900">{totalConsumption}L</p>
        </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Consumo Detalhado</h3>
          ...
          {filteredData.slice(0, 5).map((record) => (
            <Card key={record.id} className="p-4">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xl font-bold text-gray-900">{record.amount} Litros</p>
              </div>
            </Card>
          ))}
        </div>

...
import { RegisterConsumptionModal } from "@/components/register-consumption-modal";
...
export default function DashboardPage() {
  ...
  const goalProgress = activeGoal
    ? (todayConsumption.amount / activeGoal.targetAmount) * 100
    : 0;
  const isOverGoal =
    todayConsumption.amount > (activeGoal?.targetAmount || 150);
